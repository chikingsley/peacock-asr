...
:class:`~omni_curator.data.sample.Sample`s, which flow through :mod:`~omni_curator.process`
(16 kHz / normalize / tokenizer-coverage) into :mod:`~omni_curator.data.store` (SQLite), scored by
:mod:`~omni_curator.audit.benchmark` (WER/CER) and materialized by :mod:`~omni_curator.data.export`.
"""
