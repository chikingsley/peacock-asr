...
- 1. Transfer the encoder to an accent-contained model and train on augmented correctly pronounced L2 speech.
- 1. Fine-tune on mispronounced L2 speech, replacing mispronounced phone labels with their anti-phone counterparts.
- Comparison variants:
