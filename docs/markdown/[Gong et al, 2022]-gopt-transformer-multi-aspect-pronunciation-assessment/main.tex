...
%\title{G\MakeLowercase{o}PT: Multi-Granularity and Multi-Dimensional Transformer Based Non-native Speaker Pronunciation Assessment}
%
% % Single address.
% % ---------------
...
%
% Info of PAII Researchers
% - Ziyi Chen (chenziyi253@pingan.com.cn)
% - Iek-Heng Chu (zhuyixing276@pingan.com.cn)
% - Peng Chang (changpeng805@pingan.com.cn)
%
...
%PAII-AM1 and PAII-AM2 models are factorized TDNN models\cite{povey_semi-orthogonal_2018} with different training data and number of layers. The training data of PAII-AM1 consists of 452 hours TED-LIUM 3\cite{hernandez2018ted} data and 1696 hours of data from 5994 non-native speakers aged between 17 and 60. The PAII-AM2 is trained with total of 7586 hours data. The data comes from WSJ, TED-LIUM 3, Librispeech100, librispeech360 and 6591 hours of non-native speaker data. The non-native audios are from 666k speakers aged from 17 to 60. PAII-AM1 has 5 factorized TDNN layers. The output dimension of each layer is set to 256 and 1536, respectively. The final output dimension is 5184. PAII-AM2 keeps the same layer dimension, but increases the number of layers to 13.
...
%demonstrating the effectiveness of GOPT.
