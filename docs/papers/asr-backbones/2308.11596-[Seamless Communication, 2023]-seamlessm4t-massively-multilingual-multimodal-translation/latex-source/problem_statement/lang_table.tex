\begin{table*}[!p]\centering\centering\scriptsize\begin{tabular}{clllllll}
\toprule
\textbf{Code} & \textbf{Language name} & \textbf{Family} & \textbf{Subgrouping} & \textbf{Script} & \textbf{Resource} & \textbf{Source} & \textbf{Target} \\
\midrule
...
\textbf{\mfourt languages.} We display the language code, name, family, subgroup, and script, as well as the speech resource level and whether the language is supported as a source or a target in the speech and/or text modalities. Zero-shot here refers to \st or \sst tasks with the language in question as source.
}
\end{table*}
