...
@click.option('--log_dir', default='Models/lora-ft', type=str)
...
def main(config_path, seed, log_dir, lora_r, lora_alpha, lora_path, start):
    ...
    wandb.init(project=config['wandb_project'], name=config['wandb_run'], config=config)  # <--- Add this line
    wandb.config.update(config)  # <--- Add this line
