...
URL Source: http://www.sesame.com/research/crossing_the_uncanny_valley_of_voice
...
1\. Microphone permission is required. 2. Calls are recorded for quality review but not used for ML training and are deleted within 30 days. 3. By using this demo, you are agreeing to our [Terms of Use](https://www.sesame.com/terms) and [Privacy Policy](https://www.sesame.com/privacy). 4. We recommend using Chrome (Audio quality may be degraded in iOS/Safari 17.5).
