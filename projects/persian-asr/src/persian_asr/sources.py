...
#: ``persian_asr_dataset.canonical.cv25_samples`` — not an MDC id. Register
...
#: ``persian_asr_dataset.canonical.youtube_samples``. No vetted channel list exists anywhere in
