# P010: MuFFIN Replication + CHConv Improvement Plan

## Context

We're replicating MuFFIN (Yan et al. 2025, PCC **0.742** on SpeechOcean762) — current SOTA for phone-level pronunciation scoring. Our previous best is 0.677 PCC (GOP-SF + GOPT, Track 05). Then we improve it with CHConv layer aggregation (Shih & Harwath 2024/2025) — nobody has applied this to pronunciation assessment.
...
- `uv run p010 download` — pull HF features
