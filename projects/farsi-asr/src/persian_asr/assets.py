...
(``persian_omnilingual_asr.fairseq2_assets``) load on every fairseq2 init. So this module does
...
from persian_omnilingual_asr.fairseq2_assets import (
...
# This file lives at src/persian_asr/assets.py, so parents[2] is the persian-asr project root.
...
PRODUCTION_MODEL = "omni_ctc_300m_v2_persian_scribe_v4_rewarm_production"
...
def setup_fairseq2_extension(container: DependencyContainer) -> None:
    ...
    register_cards(container, "persian_asr", CARDS)
