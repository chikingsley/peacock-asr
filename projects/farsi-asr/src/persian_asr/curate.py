...
from persian_asr import DATA, DB, LANGUAGE, ROOT, SCRIPT, sources
...
PROJECT = CuratorProject(
    ...
    # live in legacy persian_asr_dataset code, reading its own canonical-parquet data layout:
    #   - mana_tts: persian_asr_dataset.canonical.mana_tts_samples, reads data/raw/mana_tts
    #   - neyshekar: persian_asr_dataset.canonical.neyshekar_samples, reads
    #     data/raw/neyshekar_v3_asr_aligned; repair CLI persian-repair-neyshekar
    #   - worldspeech: persian_asr_dataset.canonical.worldspeech_samples, reads
    #     data/raw/worldspeech_fa_ir
    #   - thomcles: persian_asr_dataset.canonical.omni_samples over data/raw/thomcles_persian_omni,
    #     built by persian_asr_dataset.dataset_prep.thomcles, CLI persian-prepare-omni-thomcles
    #   - common_voice_25: persian_asr_dataset.canonical.cv25_samples, a local Mozilla CV v25 dump
