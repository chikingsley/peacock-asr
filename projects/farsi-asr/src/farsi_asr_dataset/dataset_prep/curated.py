...
from farsi_asr_dataset.dataset_prep.text_audit import (
    DEFAULT_TOKENIZER,
...
CORE_DATA_ROOT = PROJECT_ROOT / "src" / "farsi_asr_dataset" / "data"
...
DEFAULT_OUTPUT_ROOT = OMNI_DATA_ROOT / "training" / "omnilingual" / "farsi_asr_clean_100h_filter"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset-name", default="farsi_asr_clean_100h_filter")
