...
# This file lives at src/farsi_omnilingual_asr/fairseq2_assets.py, so parents[2] is the
...
MODEL_CARDS = [
    ...
    _model(
        "omni_ctc_300m_v2_farsi_balanced_100h_filter_best",
        _CKPTS / "omni_ctc_300m_v2_farsi_balanced_100h_filter_best/model.pt",
    ),
    _model(
        "omni_ctc_300m_v2_farsi_clean_100h_filter_best",
        _CKPTS / "omni_ctc_300m_v2_farsi_clean_100h_filter_best/model.pt",
    ),
    _model(
        "omni_ctc_300m_v2_farsi_target_100h_filter_best",
        _CKPTS / "omni_ctc_300m_v2_farsi_target_100h_filter_best/model.pt",
    ),
    _model(
        "omni_ctc_300m_v2_farsi_wer35_fastconformer_best",
        _CKPTS / "omni_ctc_300m_v2_farsi_wer35_fastconformer_best/model.pt",
    ),
    # --- Scribe exact-match (step_34000 = best == final for this run) ---
    _model(
        "omni_ctc_300m_v2_farsi_scribe_exact_match_20260525_best",
        _sharded(_FT_RUNS / "omni-ctc-300m-scribe-exact-match-20260525/ws_1.c5ad768d", 34000),
    ),
    _model(
        "omni_ctc_300m_v2_farsi_scribe_exact_match_20260525_final",
        _sharded(_FT_RUNS / "omni-ctc-300m-scribe-exact-match-20260525/ws_1.c5ad768d", 34000),
    ),
    # --- Scribe v3 max (continued from exact-match best) ---
    _model(
        "omni_ctc_300m_v2_farsi_scribe_v3_max_20260527_best_retained_step38000",
        _sharded(
            _RUNS / "omni-ctc-300m-scribe-v3-max-20260527-from-exact-best/ws_1.519fd28b", 38000
        ),
    ),
    _model(
        "omni_ctc_300m_v2_farsi_scribe_v3_max_20260527_final_step40000",
        _sharded(
...
DATASET_CARDS = [
    ...
    _dataset(
        "farsi_asr_balanced_100h_filter",
        _DATA / "training/omnilingual/farsi_asr_balanced_100h_filter/version=0",
    ),
    _dataset(
        "farsi_asr_clean_100h_filter",
        _DATA / "training/omnilingual/farsi_asr_clean_100h_filter/version=0",
    ),
    _dataset(
        "farsi_asr_target_100h_filter",
        _DATA / "training/omnilingual/farsi_asr_target_100h_filter/version=0",
    ),
    _dataset(
        "farsi_asr_scribe_exact_match_20260525",
        _DATA / "training/omnilingual/farsi_asr_scribe_exact_match_20260525/version=0",
    ),
    _dataset(
        "farsi_asr_scribe_v3_max_20260527",
        _DATA / "training/omnilingual/farsi_asr_scribe_v3_max_20260527/version=0",
    ),
...
def setup_fairseq2_extension(container: DependencyContainer) -> None:
    register_cards(container, "farsi_omnilingual_asr", CARDS)
