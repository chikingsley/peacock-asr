...
from russian_asr import DATA, LANGUAGE, ROOT
...
PROJECT = FinetuneProject(
    ...
    root=ROOT,
    presets={
        # v0 = the first Russian export (YouTube + Pimsleur). num_steps is a placeholder until the
        # export prints real hours — set it for 3-5 epochs at that hour count before launching.
        "russian-corpus-v0-300m": TrainingPreset(
            config=lambda: gpu_max_finetune(
                model="omni_ctc_300m_v2_russian_base",
                dataset="russian_asr_corpus",
            ...
            output_dir=ROOT / "runs/omni-ctc-300m-russian-asr-corpus-v0",
        ),
    },
    model_card="omni_ctc_300m_v2_russian_base",
    dataset_card="russian_asr_corpus",
    ...
    default_output_dir=ROOT / "runs/omni-ctc-300m-russian-asr-corpus-v0",
    eval_dataset_root=DATA / "datasets/v0/version=0",
    eval_models={"base": "omni_ctc_300m_v2_russian_base"},
