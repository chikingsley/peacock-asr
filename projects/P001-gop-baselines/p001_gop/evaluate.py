...
Adapted from the vendored P001 CTC-based-GOP evaluation script:
`projects/P001-gop-baselines/third_party/CTC-based-GOP/is24/evaluation/spo762/evaluate_gop_feats.py`
Reference: https://github.com/YuanGongND/gopt (Gong et al.)

Supports two modes:
  1. Scalar GOP scores → per-phone polynomial regression (original)
  2. Feature vectors → per-phone SVR (following the vendored CTC-based-GOP reference)
"""
