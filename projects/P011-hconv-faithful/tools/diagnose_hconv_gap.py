...
from p011.data import AllLayerDataset, GoPDataset, SSL_MODEL_KEYS
from p011.models import AllLayerInterfaceModel, HierCB
from p011.settings import SSLInterfaceMode

DATA_DIR = Path("~/data/p011-features").expanduser()
...
from p011.models.ssl_interface import PhoneHConvInterface
