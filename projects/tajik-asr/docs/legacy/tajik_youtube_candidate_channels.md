# Tajik YouTube Candidate Channels
...
- тоҷикӣ забони тоҷикӣ
- омӯзиши забони тоҷикӣ
- дарси забони тоҷикӣ
- точики точикон тоҷикон
- барномаи тоҷикӣ суҳбат
- ахбори тоҷикӣ Тоҷикистон
- афсонаҳои тоҷикӣ кӯдакон
...
- **ИМШАБ (Imshab)**: youtube.com/channel/UCHO6nwCa8_Xw7RMr8I8ZcGA — `jPAsD3K5Otc` — late-night talk/interview (~50min).
- **KING I**: youtube.com/channel/UCitWCMzAMvslaiouAsM1wXQ — `cqIkt5xf3JI` — billed "суҳбат бо забони тоҷикӣ"; clean Tajik talk. **Strong.**
