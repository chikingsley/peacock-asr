...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--skip-prewarm",
        action="store_true",
        help="Skip the k2 prewarm step and launch the eval sweep directly.",
    )
    parser.add_argument(
        "--launch-after",
...
def main() -> int:
    ...
    state: dict[str, Any] = {
        ...
        "stage": "prewarm" if not args.skip_prewarm else "create_sweep",
    }
    ...
    if args.launch_after:
        watch_script = project_root / "code" / "orchestration" / "watch_agent_log_and_launch.py"
