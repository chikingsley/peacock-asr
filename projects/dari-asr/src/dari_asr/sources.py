...
YOUTUBE_CHANNELS: tuple[Channel, ...] = (
    ...
    _ch("tamadon_tv", "UCoSyk1fwUQmg62AaYGpFBrg", "noisy", "Tamadon TV, Kabul; Dari, Hazara-leaning; religious + current affairs."),
    ...
    _ch("hasht_e_subh", "https://www.youtube.com/c/HashteSubh", "clean", "8AM Media; independent daily, Dari reports + analysis."),
    _ch("etilaatroz", "UCzHJdCIIP8mQIDTdMU_sjdg", "clean", "Etilaatroz; investigative outlet, strongly Dari news + explainers."),
    _ch("voa_dari", "https://www.youtube.com/user/voaafghanistandari", "clean", "VOA Dari service; news, interviews, documentary (Dari-dedicated)."),
    _ch("rta_dari", "@RTADari", "clean", "RTA Dari; state broadcaster, clean anchor read (split from RTA Pashto)."),
    _ch("azadi_radio", "UCvpFmIw-T0BH8rn13CPfWlQ", "clean", "RFE/RL Radio Azadi; Dari + Pashto mixed — segment-filter for Dari."),
    _ch("begum_tv", "UCydAOOGYH4dGsgN_tuzzpwA", "noisy", "Begum TV (Paris); women's channel, educational + talk, Dari."),
    _ch("rukhshana_media", "UCOuxkvA_Re5h2wOBPR7KKbg", "noisy", "Rukhshana Media; women-focused Dari interviews (+English — filter)."),
