...
from .query import build_env_flags, build_offer_query

TEMPLATE_REGISTRY = Path(
    "/home/simon/github/peacock-asr/projects/P004-training-from-scratch/experiments/control_plane/vast_templates.json"
)
